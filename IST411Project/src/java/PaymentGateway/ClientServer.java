...
public class ClientServer extends Thread {
    ...
    public static void staticWriteSocket(Socket sock, String str){
       try { 
           ClientServer b = new ClientServer();
           b.writeToSocket(sock, str);
    ...
    public static String staticReadSocket(Socket sock) throws IOException{
           ClientServer c = new ClientServer();
           String str = c.readFromSocket(sock);
           return str;
    }
} // ClientServer
